...
and open the following three PDFs under `output/ruler-herbie-eval/results/pre-gen-2021-04-13-1331`:
  _ for Figure 7a: `by-config-all-tests-avg_bits_err_improve-boxplot.pdf`
  _ for Figure 7b: `by-config-all-tests-output_parens-boxplot.pdf`
  _ for Figure 7c: `by-config-all-tests-time-boxplot.pdf`
