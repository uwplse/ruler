...
pub fn bool_rules() -> Ruleset<Bool> {
    ...
    let rules_1 = Bool::run_workload(terms_1.clone(), all_rules.clone(), Limits::rulefinding());
    ...
    let rules_2 = Bool::run_workload(terms_2.clone(), all_rules.clone(), Limits::rulefinding());
    ...
    let rules_3 = Bool::run_workload(terms_3.clone(), all_rules.clone(), Limits::rulefinding());
