...
// This version of this file is for debugging/development. For a cleaner
// version, see szalinski.rs
...
#![allow(dead_code)]
use egg::{AstSize, CostFunction, Extractor, Language, RecExpr, Runner};
...
mod tests {
    ...
    fn rule_lifting_overfit() {
        ...
        let atoms3 = Workload::new([
            "(Scale (Vec3 sa sb sc) (Cube (Vec3 1 1 1) false))",
            "(Cube (Vec3 sa sb sc) false)",
            "(Scale (Vec3 sa sa sa) (Sphere 1 ?params))",
            "(Sphere sa ?params)",
            "(Scale (Vec3 r r h) (Cylinder (Vec3 1 1 1) params true))",
            "(Cylinder (Vec3  h r r) params true)",
            "(Scale (Vec3 sa sb sc) (Trans (Vec3 ta tb tc) a))",
            "(Trans (Vec3 (* ta sa) (* tb sb) (* tc sc)) (Scale (Vec3 sa sb sc) a))",
            "(Trans (Vec3 ta tb tc) (Scale (Vec3 sa sb sc) a))",
            "(Scale (Vec3 sa sb sc) (Trans (Vec3 (/ ta sa) (/ tb sb) (/ tc sc)) a))",
            "(Trans (Vec3 0 0 0) a)",
            "a",
            "(Scale (Vec3 1 1 1) a)",
            "a",
    ...
    fn rule_lifting_recipe2() {
        ...
        for i in 2..4 {
            ...
            let (allowed, _) =
                all_rules.partition(|rule| CF::is_allowed_rewrite(&rule.lhs, &rule.rhs));
