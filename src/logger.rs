...
pub fn write_output<L: SynthLanguage>(
    ...
    if derive {
        ...
        let stats = json!({
            ...
            "num_baseline": baseline.len(),
            "time": time_rules.as_secs_f64(),
            "enumo_to_baseline_lhs": vec![""],
            "enumo_to_baseline_lhs_num": 0,
            "enumo_to_baseline_lhs_time": Duration::default().as_secs_f64(),
            "enumo_to_baseline_lhs_rhs": vec![""],
            "enumo_to_baseline_lhsrhs_num": 0,
            "enumo_to_baseline_lhsrhs_time": Duration::default().as_secs_f64(),
            "enumo_to_baseline_all": vec![""],
            "enumo_to_baseline_all_num": 0,
            "enumo_to_baseline_all_time": Duration::default().as_secs_f64(),
            "baseline_to_enumo_lhs_num": 0,
            "baseline_to_enumo_lhs_time": Duration::default().as_secs_f64(),
            "baseline_to_enumo_lhsrhs_num": 0,
            "baseline_to_enumo_lhsrhs_time": Duration::default().as_secs_f64(),
            "baseline_to_enumo_all_num": 0,
            "baseline_to_enumo_all_time": Duration::default().as_secs_f64(),
            "minimization strategy": "compress",
        });
