...
let make_entry = (text) => {
    ...
    let egraph_size_pattern = /egraph n=([\d]+), e=([\d]+), cv=([\d]+)/gm;
...
input_folder = "C:\\Users\\gijin\\Documents\\uw\\ruler\\ablation\\";
output_path = "C:\\Users\\gijin\\Documents\\uw\\ruler\\ablation\\parsed.json";
